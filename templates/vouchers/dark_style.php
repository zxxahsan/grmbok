...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .voucher { background: linear-gradient(135deg, #e94560 0%, #0f3460 100%); color: white; padding: 30px; width: 400px; border-radius: 15px; box-shadow: 0 20px 50px rgba(233, 69, 96, 0.4); position: relative; overflow: hidden; }
        .voucher::before { content: ''; position: absolute; top: -50%; left: -50%; width: 200%; height: 200%; background: radial-gradient(circle, rgba(233, 69, 96, 0.1) 0%, transparent 70%); animation: pulse 4s ease-in-out infinite; }
        ...
        .qr-code { width: 70px; height: 70px; background: white; margin: 15px auto; display: flex; align-items: center; justify-content: center; font-size: 9px; color: #e94560; border-radius: 8px; }
    </style>
</head>
<body>
    <div class="voucher">
